...
- **72 shipped PM skills in `skills/`** (30 phase skills across 6 phases, 11 foundation skills, 16 utility skills, 15 tool skills)
...
All 72 skills are available immediately. Invoke any by name, for example `/pm-skills:deliver-prd`. Already on the old `pm-skills-marketplace`? It keeps working; see [Setup by Platform](https://product-on-purpose.github.io/pm-skills/getting-started/platforms/) to switch homes.
...
```
skills/            # All 72 skill definitions (30 phase + 11 foundation + 16 utility + 15 tool, flat)
