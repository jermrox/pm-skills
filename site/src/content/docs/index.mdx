---
title: PM Skills
description: 72 AI agent skills for product managers - open-source, spec-compliant, and ready for Claude Code, Cursor, GitHub Copilot, and more. Turn any AI assistant into a PM that ships professional PRDs, user stories, experiment designs, and workshop outputs on demand.
tags:
  - Home
---
...
**72 best-practice product management skills for AI agents.**
...
<CardGrid>
  ...
  <Card title="Utility (16 skills)" icon="pencil">
...
- **Utility (16)** - meta-tooling that builds, validates, and maintains the library itself, plus `utility-pm-workflow-builder` for authoring new workflows, `utility-pm-workflow-orchestrator` for governed multi-skill runs, and the sub-agents that handle adversarial review, catalog auditing, changelog curation, and release orchestration.
