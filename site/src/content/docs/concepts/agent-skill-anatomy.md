...
└────┬─────┘                    └────┬─────┘
     ...
     ▼                                ▼
┌──────────────────┐           ┌──────────────────┐
│ AI sees 71 skills│           │ AI loads 1 skill │
...
**Current repo note**: `AGENTS.md` registers all 71 skills in `skills/`, including domain, foundation, and utility classifications.
...
**Benefit**: Context-appropriate loading.only the selected skill loads, not all 71 skills
...
- Without progressive loading: ~500KB (all 71 skills fully loaded)
