...
See also [`docs/concepts/design-sprint.md`](../site/src/content/docs/concepts/design-sprint.md) for the conceptual explainer and [`docs/guides/using-design-sprint.md`](../site/src/content/docs/guides/using-design-sprint.md) for the operational guide (ships in v2.15.0).
