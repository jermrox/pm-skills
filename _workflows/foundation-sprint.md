...
See also [`docs/concepts/foundation-sprint.md`](../site/src/content/docs/concepts/foundation-sprint.md) for the conceptual explainer and [`docs/guides/using-foundation-sprint.md`](../site/src/content/docs/guides/using-foundation-sprint.md) for the operational guide (ships in v2.15.0).
