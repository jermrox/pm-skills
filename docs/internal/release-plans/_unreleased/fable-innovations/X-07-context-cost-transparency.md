...
- **Unrelated to the memory plan (shipped with v2.32.0).** [`docs/internal/release-plans/v2.32.0/plan_project-memory.md`](../../v2.32.0/plan_project-memory.md) (F-48, project state) is a different axis (session-to-session state, not per-skill catalog metadata); no overlap.
