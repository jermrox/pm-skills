...
The project-memory plan (F-48, the project-state keystone; shipped with v2.32.0, now at `docs/internal/release-plans/v2.32.0/plan_project-memory.md`) has no direct relationship to a benchmark and is not touched by this bet.
