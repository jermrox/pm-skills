...
<!-- pmskills:version-badge:end -->
  ...
  <a href="#the-skill-library">
    <img src="https://img.shields.io/badge/skills-71-brightgreen.svg?style=flat-square" alt="Skills">
  </a>
...
After installing, you'll have all 71 skills available (invoke any by name, like `/pm-skills:deliver-prd`, `/pm-skills:define-hypothesis`, `/pm-skills:deliver-user-stories`) plus 10 `/workflow-*` orchestrator commands and the `/chain` ad-hoc runner, templates, sub-agents, and 200+ sample outputs.
...
- ✅ **71 Production-Ready Skills** covering the complete product lifecycle (30 phase skills + 11 foundation skills + 15 utility skills + 15 tool skills for structured workshop methodologies)
...
All 71 skills and their slash commands become available immediately. No clone required.
...
<p>
  ...
  <img src="https://img.shields.io/badge/Utility-15_skills-ea580c?style=for-the-badge" alt="Utility Skills: 15">
</p>
...
| **Utility** (meta-tooling)           | 15    | pm-skill-builder, pm-skill-validate, pm-skill-iterate, pm-workflow-builder, pm-workflow-orchestrator, mermaid-diagrams, slideshow-creator, update-pm-skills, and helpers |
...
| **Skill count**     | 71 skills (30 phase + 11 foundation + 15 utility + 15 tool)                               |
...
```
pm-skills/
├── skills/                  # 71 PM skills (30 phase, 11 foundation, 15 utility, 15 tool)
...
| Path                                                             | What's in it                                                                          |
| ---------------------------------------------------------------- | ------------------------------------------------------------------------------------- |
| [`skills/`](skills/)                                             | All 71 PM skills, each with SKILL.md + references/TEMPLATE.md + references/EXAMPLE.md |
...
<details>
<summary><strong>Do I need to install all 71 skills?</strong></summary>
...
**pm-skills** (this repo) is the source skill library with all 71 PM skills as markdown files. Best for Claude Code slash commands, file browsing, and customization.
